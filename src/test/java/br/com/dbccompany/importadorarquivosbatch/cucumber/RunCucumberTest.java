...
@SelectPackages("br.com.dbccompany.importadorarquivosbatch.cucumber.stepdefs")
@SuiteDisplayName("Suite that gathers all Acceptance tests with Cucumber")
@ConfigurationParameters({
        @ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "br.com.dbccompany.importadorarquivosbatch.cucumber"),
